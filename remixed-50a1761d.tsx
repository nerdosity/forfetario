...
const ForfettarioCalculator = () => {
  ...
  // Acconti versati PER l'anno di riferimento
  const [accontiImposteVersatiPerAnnoCorrente, setAccontiImposteVersatiPerAnnoCorrente] = useState(0)

  // Contributi INPS versati DURANTE l'anno di riferimento
  const [contributiVersatiDuranteAnnoRiferimento, setContributiVersatiDuranteAnnoRiferimento] = useState(0)

  // Acconti contributi specifici versati PER l'annoRiferimento
  const [accontiContributiSeparataVersatiPerAnnoRiferimento, setAccontiContributiSeparataVersatiPerAnnoRiferimento] = useState(0)
  const [accontiContributiEccedenzaArtCommVersatiPerAnnoRiferimento, setAccontiContributiEccedenzaArtCommVersatiPerAnnoRiferimento] = useState(0)

  // Dati per quadratura anno precedente
  const [contributiVersatiDuranteAnnoPrecedente, setContributiVersatiDuranteAnnoPrecedente] = useState(0)
  const [accontiImposteVersatiPerAnnoPrecedente, setAccontiImposteVersatiPerAnnoPrecedente] = useState(0)
    ...
    <div className='max-w-7xl mx-auto p-6 bg-white'>
      <div className='text-center mb-8'>
        ...
        <h1 className='text-3xl font-bold text-gray-800 mb-2'>
          Calcolatore Forfettario Professionale
        </h1>
        <p className='text-gray-600'>
          Calcoli precisi, calendario fiscale completo e gestione regimi multipli - Anno {annoRiferimento}
        </p>
      </div>
              ...
              <div className='space-y-3'>
                <div>
                  ...
                  <input
                    ...
                    min='0'
                    step='0.01'
                    placeholder='Importo versato anno in corso'
                  />
                                      <p className='text-xs text-gray-600 mt-1'>Per deducibilità imposte {annoRiferimento - 1}</p>
                </div>
              </div>
            </div>
                ...
                <div className='space-y-4 bg-gray-100 p-4 rounded-lg'>
                  ...
                  <div>
                    ...
                    <input
                      ...
                      min='0'
                      step='0.01'
                      placeholder='Es: importo acconti versati'
                    />
